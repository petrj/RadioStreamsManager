...
$stations_json_path = __DIR__ . '/stations.json';
$default_stations = [];
if (file_exists($stations_json_path)) {
    $json_content = file_get_contents($stations_json_path);
    $default_stations = json_decode($json_content, true) ?: [];
}
